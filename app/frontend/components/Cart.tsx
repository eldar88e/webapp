  ...
  return cart.length === 0 ? (
    <div className="no-items-wrapper">
      <div className="w-full">
        <div className="flex justify-center text-gray-no-active w-full mb-1">
          <SvgIcon name="cart-empty" width={40} />
        </div>
    ...
    <>
      ...
      {cart.length === 1 && cart[0].quantity === 1 && (
        <div
          className="relative overflow-hidden mb-5 p-5"
          style={{ backgroundColor: "#48C928", borderRadius: "20px" }}
        >
          <div className="text-white font-semibold">
            Добавьте еще 1 позицию и<br />
            доставка станет 0₽ вместо 500₽
          </div>
